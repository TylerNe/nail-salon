...
// Expenses variables (shared with expenses-ui.js)
let expensesData = [];
let expensesTable = null;
let currentExpenseId = null;

// Transactions variables (shared with transactions.js)
let transactionsData = [];
let transactionsTable = null;

// Gift Cards variables (shared with gift-cards.js)
let giftCardsData = [];
...
function setupEventListeners() {
    ...
    // PIN controls for Expenses (handlers are implemented in expenses-ui.js)
    const pinCancelBtn = document.getElementById('expensesPinCancel');
    if (pinCancelBtn) {
        pinCancelBtn.addEventListener('click', handleExpensesPinCancel);
    }
    ...
    // Backspace button
    const pinBackspaceBtn = document.getElementById('pinBackspace');
    if (pinBackspaceBtn) {
        pinBackspaceBtn.addEventListener('click', removePinNumber);
    }
    ...
    // Work schedule controls (handlers are implemented in work-schedule.js)
